...
export default function SettlePage() {
  const { broker, executeSettlement, reset } = useBroker();
  ...
  return (
    <>
      <PageHeader
        ...
        description="Execute the bounded settlement and store a durable receipt onchain."
      />
        ...
        {broker.settled && broker.receipt && (
          <div className="rounded-2xl border border-emerald-200/50 bg-emerald-50/20 p-6 text-center">
            ...
            <p className="mt-2 text-[0.82rem] leading-7 text-emerald-700/80">
              Task evaluated privately, delegation bounded, settlement executed,
              receipt stored durably.
            </p>
            <button
              type="button"
